  ...
  <div class="grid-container">
      ...
      <form id="question-form" method="POST" action="">
          <form method="POST" action="">
              ...
              <button type="submit" name="submit" onclick="openModal()">Save question</button>
          </form>
      </div>
  </div>

  <script>
        // Debugging code to check when the modal is closed
    function debugCloseModal() {
        console.log("Modal closed");
    }

    // Debugging code to check when the modal is opened
    ...
    // Prevent the form from submitting and show the modal
